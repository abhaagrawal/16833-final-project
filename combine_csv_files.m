...
csvwrite('Data/lidar_data.csv', all_lidar_data);
...
csvwrite('Data/lidar_pts_per_timestep.csv', all_lidar_timestep);
...
csvwrite('Data/lidar_timestamps.csv', all_lidar_timestamp);